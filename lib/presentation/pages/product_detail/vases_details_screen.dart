...
class VaseDetailsScreen extends StatefulWidget {
  ...
  const VaseDetailsScreen({
    super.key,
    this.productName = 'Marble Flower Vase',
    this.initialPrice = 85.0,
    required this.productImage,
  });

  @override
  State<VaseDetailsScreen> createState() => _VaseDetailsScreenState();
}

class _VaseDetailsScreenState extends State<VaseDetailsScreen> {
