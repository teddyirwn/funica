...
class ChairDetailsScreen extends StatefulWidget {
  ...
  const ChairDetailsScreen({
    super.key,
    this.productName = 'Modern Wingback',
    this.initialPrice = 140.0,
    required this.productImage,
  });

  @override
  State<ChairDetailsScreen> createState() => _ChairDetailsScreenState();
}

class _ChairDetailsScreenState extends State<ChairDetailsScreen> {
  bool _isFavorite = false;
  int _quantity = 1;
  int _selectedColorIndex = 0;

  final List<Color> _availableColors = [
    const Color(0xFF35383F), // Dark Slate
