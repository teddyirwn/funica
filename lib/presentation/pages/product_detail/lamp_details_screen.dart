...
class LampDetailsScreen extends StatefulWidget {
  final String productName;
  final double initialPrice;
  final String productImage;

  const LampDetailsScreen({
    super.key,
    this.productName = 'Parabolic Reflector',
    this.initialPrice = 85.0,
    required this.productImage,
  });

  @override
  State<LampDetailsScreen> createState() => _LampDetailsScreenState();
}

class _LampDetailsScreenState extends State<LampDetailsScreen> {
  ...
  final List<Color> _availableColors = [
    ...
    const Color(0xFF707070), // Dark Grey
    const Color(0xFF35383F), // Charcoal
    const Color(0xFF5A7285), // Blue Slate
  ];
