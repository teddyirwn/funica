...
class SofaDetailsScreen extends StatefulWidget {
  final String productName;
  final double initialPrice;
  final String productImage;

  const SofaDetailsScreen({
    super.key,
    this.productName = 'Mid Century Sofa',
    this.initialPrice = 140.0,
    required this.productImage,
  });

  @override
  State<SofaDetailsScreen> createState() => _SofaDetailsScreenState();
}

class _SofaDetailsScreenState extends State<SofaDetailsScreen> {
  bool _isFavorite = false;
  int _quantity = 2;
  int _selectedColorIndex = 0;

  final List<Color> _availableColors = [
    const Color(0xFF7A5444), // Brown
    const Color(0xFF5A7285), // Grey Blue
    const Color(0xFFA020F0), // Purple
    const Color(0xFF707070), // Grey
    const Color(0xFF3B5998), // Royal Blue
